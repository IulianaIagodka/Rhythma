...
export const copy = {
  uk: {
    ...
    eventAdviceLocked: 'Рекомендації по навантаженню доступні в Pro',
    ...
    cycleRhythmLocked: 'Карта фаз доступна в Pro',
  ...
  en: {
    ...
    eventAdviceLocked: 'Load recommendations are available in Pro',
    ...
    cycleRhythmLocked: 'The phase map is available in Pro',
    rhythmToday: 'Today',
