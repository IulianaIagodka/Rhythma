...
export const copy = {
  uk: {
    ...
    calendar: 'Календар',
    calendarDesc: 'Події та тренування з календаря iPhone',
    ...
    calendarSyncLocked: 'Щоб увімкнути, потрібна оплата Plus',
    eventAdviceLocked: 'Щоб увімкнути, потрібна оплата Plus',
    ...
    freePlan: 'Free',
    plusBadge: 'Plus',
    plusPayToEnable: 'Щоб увімкнути, потрібна оплата Plus',
    proFeatureLocked: 'Щоб увімкнути, потрібна оплата Plus',
    proPhaseLists: 'Підказки фази',
    phaseListsDesc: 'Короткі підказки фази',
    proReadyHint: 'Синхронізація, рекомендації та підказки фази — у Plus, після оплати.',
    devPlan: 'Dev',
    proPlan: 'Plus',
    ...
    cycleRhythmLocked: 'Щоб увімкнути, потрібна оплата Plus',
    ...
    phaseRecommendationsHint: 'Що пасує до фази, а що краще відкласти',
    bestForPhase: 'Підходить зараз',
    avoidThisPhase: 'Краще відкласти',
    featureOn: 'Увімкнено',
  ...
  en: {
    ...
    settings: 'Settings',
    calendar: 'Calendar',
    calendarDesc: 'Events and workouts from the iPhone Calendar',
    ...
    calendarSyncLocked: 'Pay for Plus to turn this on',
    eventAdviceLocked: 'Pay for Plus to turn this on',
    ...
    freePlan: 'Free',
    plusBadge: 'Plus',
    plusPayToEnable: 'Pay for Plus to turn this on',
    proFeatureLocked: 'Pay for Plus to turn this on',
    proPhaseLists: 'Phase tips',
    phaseListsDesc: 'Short phase tips',
    proReadyHint: 'Calendar sync, recommendations, and phase tips are in Plus after purchase.',
    devPlan: 'Dev',
    proPlan: 'Plus',
    ...
    cycleRhythmLocked: 'Pay for Plus to turn this on',
    rhythmToday: 'Today',
    ...
    phaseRecommendationsHint: 'What fits this phase and what to defer',
    bestForPhase: 'Fits now',
    avoidThisPhase: 'Defer if you can',
    featureOn: 'On',
