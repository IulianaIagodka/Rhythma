...
export const copy = {
  uk: {
    ...
    paywallSubtitle: 'Плануй відповідно до свого циклу.',
    paywallLifetime: 'Одноразова покупка · Доступ назавжди',
    paywallFeatureCalendar: 'Синхронізація календаря',
  ...
  en: {
    ...
    paywallTitle: 'Rhythma Plus',
    paywallSubtitle: 'Plan around your cycle.',
    paywallLifetime: 'One-time purchase · Lifetime access',
    paywallFeatureCalendar: 'Calendar sync',
