...
export const copy = {
  uk: {
    ...
    paywallFeatureRecommendations: 'Рекомендації',
    ...
    phaseListsDesc: 'Короткі підказки фази',
    ...
    phaseRecommendationsHint: 'Так і ні для цієї фази',
    bestForPhase: 'Так',
    avoidThisPhase: 'Ні',
    featureOn: 'Увімкнено',
  ...
  en: {
    ...
    phaseRecommendationsHint: 'Yes and no for this phase',
    bestForPhase: 'Yes',
    avoidThisPhase: 'No',
    featureOn: 'On',
