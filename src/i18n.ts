...
export const copy = {
  uk: {
    ...
    calendarSyncLocked: 'Синхронізація календаря доступна в Plus',
    eventAdviceLocked: 'Рекомендації по навантаженню доступні в Plus',
    ...
    cycleRhythmLocked: 'Карта фаз доступна в Plus',
  ...
  en: {
    ...
    calendarSyncLocked: 'Calendar sync is available in Plus',
    eventAdviceLocked: 'Load recommendations are available in Plus',
    ...
    cycleRhythmLocked: 'The phase map is available in Plus',
    rhythmToday: 'Today',
